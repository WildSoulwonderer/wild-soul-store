...
export default function Home() {
  ...
  />
            ...
            {/* SKIN */}
<a href="/shop#skin" className="group block lg:mt-14">
  <div className="relative aspect-[4/6] overflow-hidden bg-[#c8b89f]">
    <Image
      src="/images/wild-soul-face.png"
      alt="Wild Soul botanical skin oils and everyday skin care in warm morning light"
      fill
      sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw"
      className="object-cover transition-transform duration-700 group-hover:scale-[1.02]"
    />
  ...
  <div className="mt-6">
    ...
    <p className="mt-2 max-w-xs text-base leading-7 text-[var(--wild-soft)]">
      Oils, balms and simple skin care made to nourish, soften and glow.
    </p>
