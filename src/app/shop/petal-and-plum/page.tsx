...
export default function PetalAndPlumPage() {
  return (
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Petal_&_Plum_Hero.jpg"
          alt="Wild Soul Petal & Plum botanical mineral soak"
          fill
          priority
    ...
    <div className="max-w-[600px]">
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          A botanical mineral soak for warm baths, tired days and a little
          time to yourself.
        </p>

        <p>
          Epsom salt and pink Himalayan salt meet white kaolin clay, vanilla
          infused oil and Kakadu plum, with honey myrtle, mandarin and
          nerolina bringing a soft, warm citrus-floral scent.
        </p>
      </div>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 px-7 py-24 sm:px-12 sm:py-32 lg:grid-cols-[1fr_1fr] lg:px-20">
    <div>
      ...
      <p
        ...
        style={serifFont}
      >
        Kakadu Plum. Mandarin. Honey Myrtle. Nerolina.
      </p>
    </div>

    <div className="max-w-[720px] space-y-6 text-xl leading-9 text-[#f4eee4]/80">
      <p>
        Some days call for something a little softer.
      </p>

      <p>
        Petal &amp; Plum combines Epsom salt and pink Himalayan salt with
        white kaolin clay, vanilla infused oil and Kakadu plum for a warm,
        botanical bath soak.
      </p>

      <p>
        Honey myrtle, mandarin and nerolina bring a soft citrus-floral scent
        that feels bright without being too much.
      </p>

      <p>
        Tip it into warm running water, let the salts disperse and take a few
        quiet minutes before getting back to everything else.
      </p>
      ...
      <p
        ...
        style={serifFont}
      >
        A softer finish to a full-on day.
      </p>
    </div>
  </div>
</section>
...
<section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
    <div className="order-2 lg:order-1">
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          Pour the contents into warm running bath water and give it a swirl
          to help the salts disperse.
        </p>

        <p>
          Sink in and soak for as long as you&apos;ve got — ten minutes,
          half an hour or until the water starts going cold.
        </p>

        <p>
          Rinse off afterwards if you like, then give the bath a quick rinse
          to clear away any petals or residue.
        </p>
        ...
        <p
          ...
          style={serifFont}
        >
          Take five. Take twenty. Take what you can get.
        </p>
      </div>
    </div>
    ...
    <div className="order-1 lg:order-2">
      <div className="relative aspect-[4/3] overflow-hidden bg-[#e1d8ca]">
        <Image
          src="/images/Petal_&_Plum_Product.jpg"
          alt="Wild Soul Petal & Plum botanical mineral soak"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
          className="object-cover"
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.8fr_1.2fr]">
    ...
    <div className="max-w-[760px]">
      <p className="text-[1.35rem] leading-9 text-[#5f574f]">
        Epsom salt, Himalayan pink salt, white kaolin clay, vanilla infused
        oil, Kakadu plum, honey myrtle, mandarin and nerolina.
      </p>
...
<section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Petal_&_Plum_Packaging.jpg"
          alt="Wild Soul Petal & Plum botanical mineral soak in kraft pouch"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
    ...
    <div className="max-w-[560px]">
      ...
      <div className="mt-8 space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          Petal &amp; Plum comes in a simple resealable kraft pouch, ready
          to tip straight into a warm bath.
        </p>

        <p>
          Keep the pouch sealed and stored somewhere dry until you&apos;re
          ready to steal a little time for yourself.
        </p>
      </div>
    </div>
  </div>
...
<section className="bg-[#f4eee4] px-7 py-28 text-center sm:px-12 sm:py-36">
  <div className="mx-auto max-w-[850px]">
    ...
    <p
      ...
      style={serifFont}
    >
      Stay until the water goes cold.
    </p>
