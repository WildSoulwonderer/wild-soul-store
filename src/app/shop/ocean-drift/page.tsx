  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Ocean_Drift_Hero.jpg"
          alt="Wild Soul Ocean Drift exfoliating salt scrub"
          fill
          priority
    ...
    <div className="max-w-[600px]">
      ...
      <p
        ...
        style={serifFont}
      >
        Fresh, salty and straight to the point.
      </p>
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          A fresh salt scrub made for rough, dry skin and the days when
          everything feels a little heavy.
        </p>

        <p>
          Pink Himalayan salt buffs away roughness while nourishing oils
          help leave skin feeling soft and smooth. Eucalyptus kochii,
          lime and spearmint give Ocean Drift its crisp, fresh edge.
        </p>
      </div>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 px-7 py-24 sm:px-12 sm:py-32 lg:grid-cols-[1fr_1fr] lg:px-20">
    <div>
      ...
      <p
        ...
        style={serifFont}
      >
        Eucalyptus Kochii. Lime. Spearmint.
      </p>
    </div>

    <div className="max-w-[720px] space-y-6 text-xl leading-9 text-[#f4eee4]/80">
      <p>
        Some days call for more than a quick rinse and calling it good.
      </p>

      <p>
        Ocean Drift combines pink Himalayan salt with nourishing oils to
        buff away rough, dry skin, while eucalyptus kochii, lime and
        spearmint bring the fresh, crisp scent.
      </p>

      <p>
        Work it over damp skin wherever things are feeling rough or dry,
        taking a little extra time on elbows, knees and anywhere that could
        use some attention.
      </p>

      <p>
        Fresh, simple and made for washing off the day and getting on with
        whatever comes next.
      </p>
      ...
      <p
        ...
        style={serifFont}
      >
        Take five. Scrub it off. Carry on.
      </p>
    </div>
  </div>
</section>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
    <div className="order-2 lg:order-1">
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        ...
        <p
          ...
          style={serifFont}
        >
          Rinse it off. Get on with your day.
        </p>
      </div>
    </div>
    ...
    <div className="order-1 lg:order-2">
      <div className="relative aspect-[4/3] overflow-hidden bg-[#e1d8ca]">
        <Image
          src="/images/Ocean_Drift_Product.jpg"
          alt="Wild Soul Ocean Drift exfoliating salt scrub"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
          className="object-contain"
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.8fr_1.2fr]">
    ...
    <div>
      <p className="text-[1.35rem] leading-9 text-[#5f574f]">
        Pink Himalayan salt with Eucalyptus Kochii, lime and spearmint.
      </p>
...
<section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Ocean_Drift_Packaging.jpg"
          alt="Wild Soul Ocean Drift exfoliating salt scrub in amber glass jar"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
          className="object-contain"
        />
    ...
    <div className="max-w-[560px]">
      ...
      <div className="mt-8 space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          Ocean Drift comes in a reusable amber glass jar with a simple
