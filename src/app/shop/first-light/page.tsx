        ...
        <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          <div>
            <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
              <Image
                src="/images/First_Light_Hero.png"
                alt="Wild Soul First Light coffee buff bar"
                fill
                priority
          ...
          <div className="max-w-[600px]">
            ...
            <p
              ...
              style={serifFont}
            >
              For mornings that start before you&apos;re ready.
            </p>
            ...
            <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
              <p>
                A solid body buff bar made for rougher mornings and skin that
                needs a proper scrub.
              </p>

              <p>
                Coffee grounds bring the grit, while shea butter, cocoa butter
                and coconut oil help leave skin feeling conditioned rather than
                stripped.
              </p>
            </div>
        ...
        <div className="mx-auto grid max-w-[1450px] gap-14 px-7 py-24 sm:px-12 sm:py-32 lg:grid-cols-[1fr_1fr] lg:px-20">
          <div>
            ...
            <p
              ...
              style={serifFont}
            >
              Coffee. Orange. No fuss.
            </p>
          </div>

          <div className="max-w-[720px] space-y-6 text-xl leading-9 text-[#f4eee4]/80">
            <p>
              Some mornings begin before your brain has caught up.
            </p>

            <p>
              First Light was made for those ones. A solid body bar with ground
              coffee for exfoliation, rich butters for slip and sweet orange to
              cut through the sleepy start.
            </p>

            <p>
              Work it over damp skin where you want a stronger scrub —
              especially elbows, knees, heels and anywhere else that&apos;s been
              dealing with dirt, dust and life.
            </p>

            <p>
              It&apos;s not delicate. It&apos;s not complicated.
            </p>
            ...
            <p
              ...
              style={serifFont}
            >
              Just a proper scrub when your skin needs one.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative aspect-[4/3] overflow-hidden bg-[#e1d8ca]">
              <Image
                src="/images/First_Light_Buff_Bar.jpg"
                alt="Wild Soul First Light coffee buff bar"
                fill
                sizes="(max-width: 1024px) 100vw, 55vw"
                className="object-cover"
        ...
        <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="max-w-[760px]">
            <p className="text-[1.35rem] leading-9 text-[#5f574f]">
              Shea butter, cocoa butter, beeswax, arrowroot powder, coffee
              grounds, coconut oil and sweet orange essential oil.
            </p>
      ...
      <section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
        <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
              <Image
                src="/images/First_Light_Packaging.jpg"
                alt="Wild Soul First Light buff bar in kraft packaging"
                fill
                sizes="(max-width: 1024px) 100vw, 55vw"
                className="object-cover"
              />
          ...
          <div className="max-w-[560px]">
            ...
            <div className="mt-8 space-y-5 text-xl leading-9 text-[#5f574f]">
              <p>
                First Light comes as a solid bar in a simple kraft window box.
              </p>

              <p>
                Keep it somewhere dry between uses and let it earn its place in
                the shower.
              </p>
            </div>
          </div>
