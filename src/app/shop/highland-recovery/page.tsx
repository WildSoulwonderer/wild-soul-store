  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Highland_Recovery_Hero.jpg"
          alt="Wild Soul Highland Recovery mineral soak"
          fill
          priority
    ...
    <div className="max-w-[600px]">
      ...
      <p
        ...
        style={serifFont}
      >
        For the days that take it out of you.
      </p>
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          A mineral bath soak made for sinking into warm water after long,
          hard days.
        </p>

        <p>
          Epsom salt and pink Himalayan salt form the mineral-rich base,
          while white kaolin clay softens the water. Cedarwood, kunzea and
          ho wood bring a warm, woody scent with a fresh bush edge.
        </p>
      </div>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 px-7 py-24 sm:px-12 sm:py-32 lg:grid-cols-[1fr_1fr] lg:px-20">
    <div>
      ...
      <p
        ...
        style={serifFont}
      >
        Cedarwood. Kunzea. Ho Wood.
      </p>
    </div>

    <div className="max-w-[720px] space-y-6 text-xl leading-9 text-[#f4eee4]/80">
      <p>
        Some days leave you feeling like you&apos;ve carried enough.
      </p>

      <p>
        Highland Recovery combines Epsom salt and pink Himalayan salt with
        white kaolin clay for a simple mineral soak made for warm baths and
        worn-out days.
      </p>

      <p>
        Cedarwood, kunzea and ho wood bring a warm, woody scent with a fresh
        bush edge that sits quietly in the background while you soak.
      </p>

      <p>
        Tip it into warm running water, let it dissolve, then give yourself
        a little time before getting back to everything else.
      </p>
      ...
      <p
        ...
        style={serifFont}
      >
        Warm water. Quiet moment. That&apos;s enough.
      </p>
    </div>
  </div>
</section>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
    <div className="order-2 lg:order-1">
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        ...
        <p>
          Sink in and soak for as long as you&apos;ve got — whether that&apos;s
          ten quiet minutes or until the water starts going cold.
        </p>
    ...
    <div className="order-1 lg:order-2">
      <div className="relative aspect-[4/3] overflow-hidden bg-[#e1d8ca]">
        <Image
          src="/images/Highland_Recovery_Product.jpg"
          alt="Wild Soul Highland Recovery mineral soak"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
          className="object-cover"
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.8fr_1.2fr]">
    ...
    <div className="max-w-[760px]">
      <p className="text-[1.35rem] leading-9 text-[#5f574f]">
        Epsom salt, Himalayan pink salt, white kaolin clay, Himalayan
        cedarwood, kunzea and ho wood.
      </p>
...
<section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Highland_Recovery_Packaging.jpg"
          alt="Wild Soul Highland Recovery mineral soak in kraft pouch"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
    ...
    <div className="max-w-[560px]">
      ...
      <div className="mt-8 space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          Highland Recovery comes in a simple resealable kraft pouch,
          ready to tip straight into a warm bath.
        </p>

        <p>
          Keep the pouch sealed and stored somewhere dry until the next
          long day calls for it.
        </p>
      </div>
    </div>
  </div>
