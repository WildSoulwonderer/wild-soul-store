...
export default function GoldenGrovePage() {
  return (
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Golden_Grove_Hero.jpg"
          alt="Wild Soul Golden Grove face and beard oil"
          fill
          priority
    ...
    <div className="max-w-[600px]">
      ...
      <p
        ...
        style={serifFont}
      >
        Everyday care with a warmer side.
      </p>
      ...
      <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          A lightweight face and beard oil made to soften and condition
          without leaving everything feeling heavy.
        </p>

        <p>
          Jojoba, camellia and apricot kernel oils form the base, with honey
          myrtle, mandarin, ho wood and mango myrtle bringing a warm, fresh
          botanical scent.
        </p>
      </div>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 px-7 py-24 sm:px-12 sm:py-32 lg:grid-cols-[1fr_1fr] lg:px-20">
    <div>
      ...
      <p
        ...
        style={serifFont}
      >
        Honey Myrtle. Mandarin. Ho Wood. Mango Myrtle.
      </p>
    </div>

    <div className="max-w-[720px] space-y-6 text-xl leading-9 text-[#f4eee4]/80">
      <p>
        Golden Grove is the softer, sunnier side of everyday skin and beard care.
      </p>
...
skin and beard hair without leaving a heavy finish.
      ...
      <p>
        Honey myrtle and mango myrtle bring the warm botanical notes, while
        mandarin adds a bright citrus lift and ho wood keeps the blend grounded.
      </p>
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
    ...
    <div className="order-1 lg:order-2">
      <div className="relative aspect-[4/3] overflow-hidden bg-[#e1d8ca]">
        <Image
          src="/images/Golden_Grove_Product.jpg"
          alt="Golden Grove face and beard oil being dispensed into a hand"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
          className="object-cover"
        />
  ...
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[0.8fr_1.2fr]">
    ...
    <div className="max-w-[760px]">
      <p className="text-[1.35rem] leading-9 text-[#5f574f]">
        Jojoba oil, camellia oil, apricot kernel oil, honey myrtle,
        mandarin, ho wood and mango myrtle.
      </p>
...
<section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
  <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
    <div>
      <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
        <Image
          src="/images/Golden_Grove_Packaging.jpg"
          alt="Wild Soul Golden Grove face and beard oil in amber glass bottle"
          fill
          sizes="(max-width: 1024px) 100vw, 55vw"
    ...
    <div className="max-w-[600px]">
      ...
      <div className="mt-8 max-w-[560px] space-y-5 text-xl leading-9 text-[#5f574f]">
        <p>
          Golden Grove comes in a 25ml amber glass bottle with a dropper,
          making it easy to use a few drops at a time.
        </p>
...
<section className="bg-[#243f35] px-7 py-24 text-center text-[#f4eee4] sm:px-12 sm:py-32 lg:px-20">
  <div className="mx-auto max-w-[900px]">
    ...
    <p
      ...
      style={serifFont}
    >
      Keep the everyday stuff simple.
    </p>
  </div>
</section>
