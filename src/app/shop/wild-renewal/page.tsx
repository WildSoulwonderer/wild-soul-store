...
export default function WildRenewalPage() {
  return (
        ...
        <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          <div>
            <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
              <Image
                src="/images/Wild_Renewal_Hero.jpg"
                alt="Wild Soul Wild Renewal coffee sugar scrub"
                fill
                priority
          ...
          <div className="max-w-[600px]">
            ...
            <p
              ...
              style={serifFont}
            >
              For skin that needs a fresh start.
            </p>
            ...
            <div className="mt-8 max-w-[570px] space-y-5 text-xl leading-9 text-[#5f574f]">
              <p>
                 A rich sugar scrub made with coffee and vanilla for skin that needs a
  proper reset.
              </p>

              <p>
                Sugar and coffee grounds buff away dry, rough skin, while nourishing oils
  leave it feeling soft, smooth and looked after.
              </p>
            </div>
...
the day.
            ...
            <p
              ...
              style={serifFont}
            >
              Coffee. Orange. Spearmint. Vanilla.
            </p>
          </div>
          ...
          <div className="max-w-[720px] space-y-6 text-xl leading-9 text-[#f4eee4]/80">
            <p>
              <p>
  Some days leave more behind than others.
</p>
            </p>

            <p>
              <p>
  Wild Renewal combines sugar and coffee grounds for a satisfying scrub,
  with nourishing oils to help leave skin feeling soft rather than stripped.
  Orange, spearmint and vanilla give it that fresh, warm kick.
</p>
            </p>

            <p>
              <p>
  Massage it over damp skin wherever things are feeling dry, dull or in need
  of a little attention, then rinse away the grit and get on with your day.
</p>
            </p>

            <p>
              <p>
  It&apos;s a little messy. That&apos;s half the point.
</p>
            </p>
            ...
            <p
              ...
              style={serifFont}
            >
              A proper reset, without making a whole thing of it.
            </p>
          </div>
        </div>
      </section>
...
Scrub it.
  ...
  Use 1–2 times a week, or whenever your skin feels like it needs a reset.
          ...
          <div className="order-1 lg:order-2">
            <div className="relative aspect-[4/3] overflow-hidden bg-[#e1d8ca]">
              <Image
                src="/images/Wild_Renewal_Product.jpg"
                alt="Wild Soul Wild Renewal coffee sugar scrub"
                fill
                sizes="(max-width: 1024px) 100vw, 55vw"
                className="object-contain"
  ...
  Brown sugar, coffee grounds, rice bran oil, coconut oil,
  vanilla infused oil, spearmint and sweet orange essential oil.
</p>
      ...
      <section className="px-7 py-24 sm:px-12 sm:py-32 lg:px-20">
        <div className="mx-auto grid max-w-[1450px] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <div className="relative aspect-[4/3] overflow-hidden bg-[#ded5c7]">
              <Image
                src="/images/Wild_Renewal_Packaging.jpg"
                alt="Wild Soul Wild Renewal sugar scrub in amber glass jar"
                fill
                sizes="(max-width: 1024px) 100vw, 55vw"
                className="object-contain"
              />
...
Use every bit.
            ...
            <div className="mt-8 space-y-5 text-xl leading-9 text-[#5f574f]">
              <p>
                <p>
  Wild Renewal comes in a reusable amber glass jar with a simple screw-top
  lid — easy to scoop from, easy to close up and keep ready for next time.
</p>
              </p>
