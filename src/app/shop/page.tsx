...
const collectionDefinitions: CollectionDefinition[] = [
  {
    ...
    description:
      "Scrubs, whipped soaps, lip care, shimmer oils, buff bars and everyday body care made for real skin, real routines and whatever five minutes you can steal.",
...
const comingSoon = [
  {
    name: "Earthbound",
    type: "Jesmonite Homewares",
    text: "Earthy, handmade Jesmonite pieces inspired by the Australian bush and the wild places we call home.",
  },
  {
    name: "Wild Soul Deodorant",
    type: "Everyday Care",
    text: "A bicarb-free stick deodorant built for Queensland days, busy bodies and everyday life.",
  },
  {
    name: "Shampoo Bars",
    type: "Hair Care",
    text: "Simple solid shampoo made for everyday use without filling the shower with another plastic bottle.",
  },
  {
    name: "Conditioner Bars",
    type: "Hair Care",
    text: "A solid conditioning bar designed to soften and smooth while keeping the routine beautifully simple.",
  },
];
...
function getCollectionId(category: string | null): CollectionDefinition["id"] {
  ...
  if (value === "bath" || value.includes("bath") || value.includes("soak")) {
    return "bath";
  }
    ...
    <main className="min-h-screen bg-[#f4eee4] text-[#243f35]">
      ...
      <section className="px-7 pb-20 pt-20 sm:px-12 sm:pb-28 sm:pt-28 lg:px-20">
        <div className="mx-auto grid max-w-[1450px] gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          <div>
            <p className="mb-6 text-sm font-semibold uppercase tracking-[0.3em] text-[#9a6545]">Shop Wild Soul</p>
            <h1 className="text-[clamp(4rem,8vw,8.5rem)] font-normal leading-[0.82] tracking-[-0.055em] text-[#243f35]" style={serifFont}>
              Made for<br /><span className="italic text-[#704a35]">real life.</span>
            </h1>
          </div>
          <div className="max-w-[650px] lg:pb-2">
            <p className="text-[1.7rem] italic leading-[1.35] text-[#704a35] sm:text-[2.2rem]" style={serifFont}>
              Small-batch care for the five minutes you didn&apos;t know you needed.
            </p>
            <p className="mt-7 max-w-[600px] text-base leading-8 text-[#5f574f] sm:text-lg sm:leading-9">
              No complicated routines. No saving the good stuff for later. Just body, bath, recovery and skin care made to be opened, used, carried around and worked into ordinary life.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#e8e1d5] px-7 py-20 sm:px-12 sm:py-28 lg:px-20">
        <div className="mx-auto max-w-[1450px]">
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <p className="mb-5 text-xs font-semibold uppercase tracking-[0.3em] text-[#9a6545]">Coming to Wild Soul</p>
              <h2 className="text-[clamp(3.2rem,6vw,6.5rem)] font-normal leading-[0.9] text-[#243f35]" style={serifFont}>
                There&apos;s more<br /><span className="italic text-[#704a35]">taking shape.</span>
              </h2>
              <p className="mt-8 max-w-[520px] text-base leading-8 text-[#5f574f] sm:text-lg sm:leading-9">
                I&apos;m always making, testing and changing things. These are the next pieces of Wild Soul currently finding their feet.
              </p>
            </div>
            <div className="grid gap-5 sm:grid-cols-2">
              {comingSoon.map((item) => (
                <article key={item.name} className="flex min-h-[280px] flex-col justify-between border border-[#243f35]/15 bg-[#f4eee4] p-8 sm:min-h-[310px] sm:p-10">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#9a6545]">{item.type}</p>
                    <h3 className="mt-5 text-4xl font-normal text-[#243f35]" style={serifFont}>{item.name}</h3>
                    <p className="mt-5 text-base leading-8 text-[#5f574f]">{item.text}</p>
                  </div>
                  <p className="mt-10 text-xs font-semibold uppercase tracking-[0.22em] text-[#704a35]">Coming Soon</p>
                </article>
              ))}
            </div>
          </div>
      ...
      <section className="bg-[#f4eee4] px-7 py-24 text-center sm:px-12 sm:py-32">
        <div className="mx-auto max-w-[900px]">
          <p className="text-[clamp(3.4rem,6vw,6.5rem)] font-normal leading-[0.92] text-[#243f35]" style={serifFont}>Use the good stuff.</p>
          <p className="mt-4 text-[clamp(2rem,3.5vw,3.5rem)] italic text-[#704a35]" style={serifFont}>Tomorrow can bloody wait.</p>
          <p className="mx-auto mt-9 max-w-[650px] text-base leading-8 text-[#5f574f] sm:text-lg sm:leading-9">Wild Soul is made to be used — in the shower, beside the bath, in the ute, in your work bag, at home or wherever life happens to find you.</p>
        </div>
      </section>

      <footer className="bg-[#243f35] text-[#f4eee4]">
        <div className="mx-auto max-w-[1600px] px-8 py-14 sm:px-14 lg:px-20 lg:py-20">
          <div className="grid gap-12 lg:grid-cols-[1.4fr_0.7fr_0.7fr]">
            <div className="max-w-[520px]">
              ...
              <p className="mt-5 text-[clamp(2.8rem,4vw,4.5rem)] font-normal leading-[0.95]" style={serifFont}>Take five.<br /><span className="italic text-[#d7b89a]">The rest can wait.</span></p>
              <p className="mt-7 max-w-[430px] text-sm leading-7 text-[#f4eee4]/70 sm:text-base">Small-batch body, bath and skincare products made in Queensland for real life.</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#c8aa8c]">Wild Soul</p>
              <p className="mt-6 max-w-[260px] text-xl italic leading-relaxed text-[#f4eee4]/75" style={serifFont}>Built for the work.<br />Made for the recovery.</p>
            </div>
          </div>
          <div className="mt-14 flex flex-col gap-4 border-t border-white/15 pt-7 text-xs text-[#f4eee4]/55 sm:flex-row sm:items-center sm:justify-between">
